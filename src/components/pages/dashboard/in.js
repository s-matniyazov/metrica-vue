(function (factory) {
    ...
    const echartSetOption = (e, t, o, r) => {
        ...
        c && c.addEventListener("navbar.vertical.toggle", (() => {
            ...
            e.resize(), r && s(r);
        })), r && s(r), i.addEventListener("clickControl", (({detail: {control: a}}) => {
    ...
    const issuesDiscoveredChartInit = () => {
        ...
        if (o) {
            const a = t(o, "echarts"), r = window.echarts.init(o);
            echartSetOption(r, a, (() => ({
                ...
                tooltip: {trigger: "item", extraCssText: "z-index: 1000", position: (...e) => handleTooltipPosition(e)},
                responsive: !0,
                    ...
                    label: {
                        ...
                        rich: {
                            x: {
                                ...
                                padding: [0, 0, 5, 15]
                            }, y: {fontSize: 12.8, color: e("tertiary-color"), fontWeight: 600}
                        }
                    },
    ...
    const zeroBurnOutChartInit = () => {
        ...
        if (r) {
            const i = e(r, "echarts"), l = window.echarts.init(r);
            echartSetOption(l, i, (() => ({
                tooltip: {
                    trigger: "axis",
                ...
                legend: {
                    ...
                    textStyle: {color: o("body-color"), fontWeight: 600, fontSize: 16, fontFamily: "Nunito Sans"}
                },
                xAxis: [{
                    show: !0,
                    interval: 2,
                    ...
                    splitLine: {interval: 0, show: !0, lineStyle: {color: o("border-color"), type: "dashed"}},
                    type: "category",
                    boundaryGap: !1,
                    data: t(15)
                }, {
                    ...
                    axisLabel: {show: !1},
                    axisTick: {show: !1},
                    splitLine: {interval: 1, show: !0, lineStyle: {color: o("border-color"), type: "solid"}},
                    boundaryGap: !1,
                    data: t(15)
                }],
                yAxis: {
                    ...
                    type: "value",
                    axisLine: {lineStyle: {type: "solid", color: o("border-color")}},
                    axisLabel: {color: o("body-color"), margin: 20, fontSize: 12.8, interval: 0},
                    splitLine: {show: !0, lineStyle: {color: o("border-color"), type: "solid"}},
                    axisTick: {show: !0, length: 15, alignWithLabel: !0, lineStyle: {color: o("border-color")}}
                },
                series: [{
                    name: "Estimated",
                    type: "line",
                    ...
                    lineStyle: {width: 0},
                    areaStyle: {color: o("primary-light"), opacity: .075},
                    tooltip: {show: !1}
                }, {
                    name: "Issues found",
                    type: "line",
                    symbolSize: 6,
                    itemStyle: {color: o("body-highlight-bg"), borderColor: o("success"), borderWidth: 2},
                    ...
                    type: "line",
                    symbolSize: 6,
                    itemStyle: {color: o("body-highlight-bg"), borderColor: o("warning"), borderWidth: 2},
                    ...
                    type: "line",
                    symbolSize: 6,
                    itemStyle: {color: o("body-highlight-bg"), borderColor: o("quaternary-color"), borderWidth: 2},
